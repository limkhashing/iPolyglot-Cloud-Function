        ...
        alQuranIndex.search(queryText)
            .then(function (res) {
                if (res.hits === undefined || res.hits.length == 0) {
                    let errorResponse = "Sorry, I couldn't found the text in Al-Quran, can you try with other words?"
                ...
                ". The meaning is " + hit.meaning + " and the translation is " + hit.translation
